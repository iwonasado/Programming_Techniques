...
namespace {
	...
	hotkey::hotkey_command_temp hotkey_list_[] = {
		...
		{ hotkey::HOTKEY_ANIMATE_MAP, "animatemap", N_("Animate Map"), false, scope_game | scope_editor | 
		  scope_main, 
		  "" },
		...
		{ hotkey::HOTKEY_ZOOM_DEFAULT, "zoomdefault", N_("Default Zoom"), false, scope_game | scope_editor | 
		  scope_main, "" },
		{ hotkey::HOTKEY_FULLSCREEN, "fullscreen", N_("Toggle Full Screen"), false, scope_game | scope_editor | 
		  scope_main, "" },
		...
		{ hotkey::HOTKEY_TERRAIN_DESCRIPTION, "describeterrain", N_("Terrain Description"), false, scope_game | 
		  scope_editor, "" },
		{ hotkey::HOTKEY_UNIT_DESCRIPTION, "describeunit", N_("Unit Description"), false, scope_game | 
		  scope_editor, "" },
		...
		{ hotkey::HOTKEY_TOGGLE_ELLIPSES, "toggleellipses", N_("Toggle Ellipses"), false, scope_game | 
		  scope_editor | scope_main, "" },
		{ hotkey::HOTKEY_TOGGLE_GRID, "togglegrid", N_("Toggle Grid"), false, scope_game | scope_editor, "" },
		{ hotkey::HOTKEY_MOUSE_SCROLL, "mousescroll", N_("Mouse Scrolling"), false, scope_game | scope_editor | 
		  scope_main, "" },
		...
		{ hotkey::HOTKEY_PREFERENCES, "preferences", N_("Preferences"), false, scope_game | scope_editor | 
		  scope_main, "" },
		...
		{ hotkey::HOTKEY_WB_EXECUTE_ACTION, "wbexecuteaction", N_("whiteboard^Execute Action"), false, 
		  scope_game, "" },
		// TRANSLATORS: whiteboard menu entry: execute all planned actions
		{ hotkey::HOTKEY_WB_EXECUTE_ALL_ACTIONS, "wbexecuteallactions", N_("whiteboard^Execute All Actions"), 
		  false, scope_game, "" },
		// TRANSLATORS: whiteboard menu entry: delete planned action
		{ hotkey::HOTKEY_WB_DELETE_ACTION, "wbdeleteaction", N_("whiteboard^Delete Action"), false, 
		  scope_game, "" },
		// TRANSLATORS: whiteboard menu entry: move planned action up queue
		{ hotkey::HOTKEY_WB_BUMP_UP_ACTION, "wbbumpupaction", N_("whiteboard^Move Action Up"), false, 
		  scope_game, "" },
		// TRANSLATORS: whiteboard menu entry: move planned action down queue
		{ hotkey::HOTKEY_WB_BUMP_DOWN_ACTION, "wbbumpdownaction", N_("whiteboard^Move Action Down"), false, 
		  scope_game, "" },
		// TRANSLATORS: whiteboard menu entry: plan as though the chosen unit were dead
		{ hotkey::HOTKEY_WB_SUPPOSE_DEAD, "wbsupposedead", N_("whiteboard^Suppose Dead"), false, scope_game, "" },

		{ hotkey::HOTKEY_EDITOR_QUIT_TO_DESKTOP, "editor-quit-to-desktop", N_("Quit to Desktop"), false, 
		  scope_editor, "" },
		...
		{ hotkey::HOTKEY_EDITOR_LOCAL_TIME, "menu-editor-local-time", N_("Assign Local Time"), true, 
		  scope_editor, "" },

		{ hotkey::HOTKEY_EDITOR_CUSTOM_TODS, "editor-custom-tods", N_("Custom Time of Day Creator"), 
		  false, scope_editor, "" },
		...
		{ hotkey::HOTKEY_EDITOR_SCENARIO_SAVE_AS, "editor-scenario-save-as", N_("Save Scenario As"), 
		  false, scope_editor, "" },
		{ hotkey::HOTKEY_EDITOR_MAP_SAVE_ALL, "editor-map-save-all", N_("Save All Maps"), 
		  false, scope_editor, "" },
		{ hotkey::HOTKEY_EDITOR_MAP_REVERT, "editor-map-revert", N_("Revert All Changes"), 
		  false, scope_editor, "" },
		...
		{ hotkey::HOTKEY_EDITOR_PALETTE_ITEM_SWAP, "editor-terrain-palette-swap", 
		  N_("Swap Foreground/Background Palette Item"), false, scope_editor, "" },
		{ hotkey::HOTKEY_EDITOR_PALETTE_GROUPS, "editor-palette-groups", N_("Change Palette Group"), 
		  false, scope_editor, "" },
		{ hotkey::HOTKEY_EDITOR_PALETTE_UPSCROLL, "editor-palette-upscroll", N_("Scroll Palette Left"), 
		  false, scope_editor, "" },
		...
		{ hotkey::HOTKEY_EDITOR_TOOL_PAINT, "editor-tool-paint", N_("Paint Tool"), false, scope_editor, 
		  N_("Usere left/right mouse button to draw fore-/background terrain. Hold Shift to paint base layer only. Ctrl+click to sample terrain under cursor.") },
		{ hotkey::HOTKEY_EDITOR_TOOL_FILL, "editor-tool-fill", N_("Fill Tool"), false, scope_editor, 
		  N_("Use left/right mouse button to draw fore-/background terrain. Hold Shift to paint base layer only. Ctrl+click to sample terrain under cursor.") },
		{ hotkey::HOTKEY_EDITOR_TOOL_SELECT, "editor-tool-select", N_("Selection Tool"), false, scope_editor, 
		  N_("Left mouse button selects or deselects with Ctrl, right brings up a context menu. Hold Shift for magic-wand selection of tiles with same terrain.") },
		{ hotkey::HOTKEY_EDITOR_TOOL_STARTING_POSITION, "editor-tool-starting-position", 
		  N_("Starting Positions Tool"), false, scope_editor, N_("Left mouse button displays player selection, right clears. Number keys scroll to the starting position, alt+number sets respective starting position under cursor, delete clears.") },
		{ hotkey::HOTKEY_EDITOR_TOOL_LABEL, "editor-tool-label", N_("Label Tool"), false, scope_editor, 
		  N_("Left mouse button sets or drags a label, right clears.") },
		{ hotkey::HOTKEY_EDITOR_TOOL_UNIT, "editor-tool-unit", N_("Unit Tool"), false, scope_editor, 
		  N_("Left mouse button sets a new unit or moves a unit via drag and drop, right brings up a context menu. Needs a defined side.") },
		{ hotkey::HOTKEY_EDITOR_TOOL_ITEM, "editor-tool-item", N_("Item Tool"), false, scope_editor, 
		  N_("Left mouse button sets a new item or moves it via drag and drop, right clears. Not implemented yet.") },
		{ hotkey::HOTKEY_EDITOR_TOOL_SOUNDSOURCE, "editor-tool-soundsource", N_("Sound Source Tool"), 
		  false, scope_editor, N_("Left mouse button sets or drags a sound source, right clears. Not implemented yet.") },
		...
		{ hotkey::HOTKEY_EDITOR_UNIT_TOGGLE_RENAMEABLE, "editor-toggle-renameable", N_("Can be Renamed"), 
		  false, scope_editor, N_("Toggle the unit being renameable.") },
		{ hotkey::HOTKEY_EDITOR_UNIT_RECRUIT_ASSIGN, "editor-unit-recruit", N_("Assign Recruit List"), 
		  false, scope_editor, N_("Assign the selected unit set as recruit list to the unit.") },

		{ hotkey::HOTKEY_EDITOR_UNIT_CHANGE_ID, "editor-change-unitid", N_("Change Unit ID"), 
		  false, scope_editor, "" },
		{ hotkey::HOTKEY_EDITOR_UNIT_TOGGLE_LOYAL, "editor-unit-toggle-loyal", N_("Loyal"), 
		  false, scope_editor, "" },
		{ hotkey::HOTKEY_EDITOR_UNIT_FACING, "menu-unit-facing", "", true, scope_editor, "" },

		{ hotkey::HOTKEY_MINIMAP_CODING_UNIT, "minimap-unit-coding", N_("Toggle Minimap Unit Coding"), 
		...
		{ hotkey::HOTKEY_MINIMAP_DRAW_VILLAGES, "minimap-draw-villages", 
		  N_("Toggle Minimap Village Drawing"), false, scope_game | scope_editor | scope_main, "" },
		...
		{ hotkey::HOTKEY_EDITOR_SELECTION_EXPORT, "editor-export-selection-coords", 
		  N_("Export Selected Coordinates to System Clipboard"), true, scope_editor, "" },
		...
		{ hotkey::HOTKEY_EDITOR_UPDATE_TRANSITIONS, "editor-update-transitions", 
		  N_("Update Terrain Transitions"), false, scope_editor, "" },

		// This item is for binding in the preferences
		{ hotkey::HOTKEY_EDITOR_TOGGLE_TRANSITIONS, "editor-toggle-transitions", 
		  N_("Toggle Terrain Transition Update"), false, scope_editor, "" },
		...
		{ hotkey::HOTKEY_EDITOR_AUTO_UPDATE_TRANSITIONS, "editor-auto-update-transitions", 
		  N_("Auto-update Terrain Transitions"), true, scope_editor, "" },
		{ hotkey::HOTKEY_EDITOR_NO_UPDATE_TRANSITIONS, "editor-no-update-transitions", 
		  N_("Auto-update Terrain Transitions: No"), true, scope_editor, "" },
		{ hotkey::HOTKEY_EDITOR_PARTIAL_UPDATE_TRANSITIONS, "editor-partial-update-transitions", 
		  N_("Auto-update Terrain Transitions: Partial"), true, scope_editor, "" },

		{ hotkey::HOTKEY_EDITOR_REFRESH_IMAGE_CACHE, "editor-refresh-image-cache", 
		  N_("Refresh Image Cache"), false, scope_editor, "" },
		{ hotkey::HOTKEY_EDITOR_DRAW_COORDINATES, "editor-draw-coordinates", 
		  N_("Draw Hex Coordinates"), false, scope_editor, "" },
		...
		{ hotkey::HOTKEY_EDITOR_AREA_RENAME, "editor-rename-area", 
		  N_("Rename Selected Area"),   false, scope_editor, "" },
		{ hotkey::HOTKEY_EDITOR_AREA_REMOVE, "editor-remove-area", 
		  N_("Remove Selected Area"),   false, scope_editor, "" },
		{ hotkey::HOTKEY_EDITOR_AREA_ADD,    "editor-add-area",    
		  N_("Add New Area"),           false, scope_editor, "" },

		{ hotkey::HOTKEY_EDITOR_SCENARIO_EDIT, "editor-scenario-edit", 
		  N_("Edit Scenario"), false, scope_editor, "" },
		...
		{ hotkey::HOTKEY_USER_CMD, "command", N_("Enter User Command"), 
		  false, scope_game | scope_editor | scope_main, "" },
		...
		{ hotkey::TITLE_SCREEN__NEXT_TIP, "title_screen__next_tip", 
		  N_("Next Tip of the Day"), false, scope_main, "" },
		{ hotkey::TITLE_SCREEN__PREVIOUS_TIP, "title_screen__previous_tip", 
		  N_("Previous Tip of the Day"), false, scope_main, "" },
		{ hotkey::TITLE_SCREEN__TUTORIAL, "title_screen__tutorial", 
		  N_("Start Tutorial"), false	, scope_main, "" },
		{ hotkey::TITLE_SCREEN__CAMPAIGN, "title_screen__campaign", 
		  N_("Start Campaign"), false	, scope_main, "" },
		{ hotkey::TITLE_SCREEN__MULTIPLAYER, "title_screen__multiplayer", 
		  N_("Start Multiplayer Game"), false, scope_main, "" },
		...
		{ hotkey::LUA_CONSOLE, "global__lua__console", N_("Show Lua Console"), 
		  false, scope_game | scope_editor | scope_main, ""},
	...
	/*
	 * the size_t are indexes for known_hotkeys, because known_hotkeys begins with input_list_, 
	 * they are also indexes for input_list_.
	 */
...
namespace hotkey {
	...
	bool remove_wml_hotkey(const std::string& id) {
		...
		else
		{
			...
			for(boost::ptr_vector<hotkey_command>::iterator itor = known_hotkeys.begin(); 
				itor != known_hotkeys.end(); ++itor)
			{
				if(itor->command == id)
				{
	...
	void add_wml_hotkey(const std::string& id, const t_string& description, const config& default_hotkey) {
		...
		else
		{
			...
			known_hotkeys.push_back(new hotkey_command(hotkey::HOTKEY_WML, id, description, false, scope_game, 
									t_string("")));
	...
	hotkey_command::hotkey_command(hotkey::HOTKEY_COMMAND cmd, const std::string& id_, const t_string& desc, 
								   bool hid, hotkey::hk_scopes scop, const t_string& toolt)
								   : id(cmd), command(id_), description(desc), hidden(hid), scope(scop), 
								   tooltip(toolt) {
	...
	bool hotkey_command::null() const {
		...
		if(id == HOTKEY_NULL || command == "null")
		{
			...
			if(id == null_cmd.id && command == null_cmd.command && scope == null_cmd.scope && description == 
	...
	void init_hotkey_commands()  {
		...
		BOOST_FOREACH(hotkey_command_temp& cmd, hotkey_list_) {
			...
			known_hotkeys.push_back( new hotkey_command(cmd.id, cmd.command, t_string(cmd.description, 
				                     "wesnoth-lib"), cmd.hidden, cmd.scope, t_string(cmd.tooltip, "wesnoth-lib")));
