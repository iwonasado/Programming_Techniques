...
namespace wb
{
	...
	public:
		...
		void turn_shift() 
		{ 
			assert(turn_size(0)==0); 
			turn_beginnings_.pop_front(); 
		}
		...
		{ 
			return actions_.replace(it, act); 
		}
		 ...
		 */
		template <typename T>
		typename action_set::index<T>::type& get()
		{ 
			return actions_.get<T>(); 
		}
		template <typename T>
		typename action_set::index<T>::type const& get() const 
		{ 
			return actions_.get<T>(); 
		}
		...
		typename action_set::index<T>::type::iterator project(U it)
		{ 
			return actions_.project<T>(it); 
		}
		template <typename T, typename U>
		typename action_set::index<T>::type::const_iterator project(U it) const 
		{ 
			return actions_.project<T>(it); 
		}
		...
		iterator begin()
		{ 
			return actions_.get<chronological>().begin(); 
		}
		/** reverse version of the above */
		reverse_iterator rbegin()
		{ 
			return actions_.get<chronological>().rbegin(); 
		}
		/** const versions of the above */
		const_iterator begin() const 
		{ 
			return actions_.get<chronological>().cbegin(); 
		}
		/** const reverse versions of the above */
		const_reverse_iterator rbegin() const 
		{ 
			return actions_.get<chronological>().crbegin(); 
		}
		...
		iterator end()
		{ 
			return actions_.get<chronological>().end(); 
		}
		/** reverse version of the above */
		reverse_iterator rend()
		{ 
			return actions_.get<chronological>().rend(); 
		}
		/** const versions of the above */
		const_iterator end() const 
		{ 
			return actions_.get<chronological>().cend(); 
		}
		/** const reverse versions of the above */
		const_reverse_iterator rend() const 
		{ 
			return actions_.get<chronological>().crend(); 
		}
		...
		{
			return crange_t(turn_begin(turn_num),turn_end(turn_num)); 
		}
		crrange_t riter_turn(size_t turn_num) const 
		{ 
			return crrange_t(turn_rbegin(turn_num),turn_rend(turn_num)); 
		}

		/** Returns the number of actions planned for turn turn_num */
		size_t turn_size(size_t turn_num) const 
		{ 
			return turn_end(turn_num) - turn_begin(turn_num); 
		}
	...
	public:
		...
		size_t team_index() 
		{ 
			assert(team_index_defined_); return team_index_; 
		}
		...
		size_t num_turns() const 
		{ 
			return actions_.num_turns(); 
		}

		/** Returns the number of actions planned for turn turn_num */
		size_t turn_size(size_t turn_num) const 
		{ 
			return actions_.turn_size(turn_num); 
		}
		...
		{ 
			return std::find(begin(), end(), action); 
		}
		...
		iterator turn_begin(size_t turn_num)
		{
			return actions_.turn_begin(turn_num); 
		}
		iterator turn_end(size_t turn_num)
		{ 
		...
		reverse_iterator turn_rbegin(size_t turn_num)
		{ 
			return actions_.turn_rbegin(turn_num); 
		}
		reverse_iterator turn_rend(size_t turn_num)
		{ 
		...
		range_t iter_turn(size_t turn_num)
		{ 
			return actions_.iter_turn(turn_num); 
		}
		rrange_t riter_turn(size_t turn_num)
		{ 
			return actions_.riter_turn(turn_num); 
		}
		crange_t iter_turn(size_t turn_num) const 
		{ 
			return actions_.iter_turn(turn_num); 
