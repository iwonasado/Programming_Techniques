...
* The second parameter is a @ref team_filter, it is called for each team, if it returns false,
* the actions of this team won't be processed.
*
...
* The actions are processed chronologically.
* The second parameter is a @ref team_filter, it is called for each team, if it returns false, 
* the actions of this team won't be considered.
*
